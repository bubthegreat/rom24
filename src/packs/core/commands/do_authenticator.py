    ...
    if arg1 == "on" or arg1 == "activate" or arg1 == "enable" or arg1 == "add":
        if ch.auth:
            ...
            if pwd != ch.pwd:
                ...
                ch.send(
                    "Please add a new time-based account to your authenticator, using %s as the code.\n"
                    % ch.auth.secret
                )
                ch.send(
                    "If you don't have a smartphone app, you can get a Windows version at https://winauth.com/\n"
                )
                return
    ...
    if arg1 == "off" or arg1 == "deactivate" or arg1 == "disable" or arg1 == "remove":
        if not ch.auth:
            ...
            if pwd != ch.pwd:
                ...
                if not arg3:
                    ch.send(
                        "You must provide the current auth token to remove your authenticator.\n"
                    )
                    return
