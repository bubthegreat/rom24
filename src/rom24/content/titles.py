...
TITLES = {'warrior': [['Man', 'Woman'],
 ...
 'healer': [['Man', 'Woman'],
            ...
            ['Holy Father', 'Holy Mother'],
            ['Patriach of Healing', 'Matriach of Healing'],
