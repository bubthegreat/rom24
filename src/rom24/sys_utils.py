...
class ResourceSnapshot:
    ...
    def log_data(self):
        ...
        results = (
            ...
            "System has %dM of %dM available (%.3f%% used)"
            % (
                self.system_memory_available(),
            ...
            "Driver has performed %d read and %d write I/O operations."
            % (self.process_io(), self.process_io(True)),
        )
        spaces = "\n" + " " * 51
